...
from surepy.entities.devices import Feeder as SurepyFeeder, Felaqua as SurepyFelaqua
...
async def async_setup_entry(
    ...
    for surepy_entity in coordinator.data.values():
        ...
        if surepy_entity.type == EntityType.FEEDER:
            entities.append(Feeder(surepy_entity.id, coordinator))
...
class Feeder(SurePetcareEntity, SensorEntity):
    """Sure Petcare Feeder."""
